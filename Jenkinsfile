   ...
   stages {
      stage("CheckOut-SCM"){
       ...
       stage("Build"){
           ...
           steps{
             sh label: '', script: 'scp /var/jenkins_home/workspace/Game-of-life/webapp/target/webapp.war ubuntu@https://github.com/HariReddy910/Isolvers-1.git:/var/lib/tomcat9/webapps/app1.war'
                   }
             }
